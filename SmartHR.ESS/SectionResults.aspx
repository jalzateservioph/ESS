<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SectionResults.aspx.cs" Inherits="ESSReports.Pages.SectionResults" %>
...
<body>
    ...
    <div>
        ...
        <dx:ASPxPivotGrid ID="pgdSection" runat="server" ClientIDMode="AutoID" EnableTheming="True" Theme="BlackGlass" OnCustomCellValue="pgdSection_CustomCellValue" OnCustomSummary="pgdSection_CustomSummary">
            <Fields>
                
                <dx:PivotGridField ID="fieldSectiont" FieldName="Section" Options-AllowFilter="True" Options-AllowSort="True" AreaIndex="0"/>
        ...
        <dx:ASPxPivotGridExporter ID="pgeExporter" runat="server" ASPxPivotGridID="pgdSection">
