...
<ClientSideEvents ValueChanged="function(s,e){
                                                                var _start,_end;
                                                                dgView_001.GetRowValues(s.VisibleIndex,'StartDate',_start);
                                                                dgView_001.GetRowValues(s.VisibleIndex,'EndDate',_start);
                                    ...
                                    <asp:PlaceHolder ID="phSpace_007" runat="server" Visible="true"><br /></asp:PlaceHolder>
                        ...
                        <dxtc:TabPage Text="Educational Background">
                            ...
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl5" runat="server">
                                    ...
                                    <asp:PlaceHolder ID="phSpace_002" runat="server" Visible="true"><br /></asp:PlaceHolder>
                        ...
                        <dxtc:TabPage Text="Licensures/Certifications">
                            ...
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl9" runat="server">
                                    ...
                                    <asp:PlaceHolder ID="phSpace_005" runat="server" Visible="true"><br /></asp:PlaceHolder>
                        ...
                        <dxtc:TabPage Text="Seminars and Trainings Attended">
                            ...
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl10" runat="server">
                                    ...
                                    <asp:PlaceHolder ID="phSpace_006" runat="server" Visible="true"><br /></asp:PlaceHolder>
