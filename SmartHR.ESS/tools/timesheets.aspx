<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="employee.aspx.vb" Inherits="SmartHR.timesheets1" ValidateRequest="false" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body>
        <form id="_timesheets1" runat="server" style="height: 100%; width: 100%">
            <div class="title">
                <div style="float: left; width: 60px">
                    <div style="padding: 3px 0px 3px 5px">
                        <div style="float: left; width: 40px">
                            <img id="cmdPrint" runat="server" style="cursor: pointer; height: 32px" src="../images/tools/performanceman_002_print.png" title="Print" />
                        </div>
                    </div>
                </div>
