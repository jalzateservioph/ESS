...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body onload="window.history.forward(); reset();">
        <form id="_index" runat="server">
            ...
            <dxpc:ASPxPopupControl ID="pcSubmit_014" runat="server" ClientInstanceName="pcSubmit_014" AllowDragging="true" CloseAction="CloseButton" EnableAnimation="false" Modal="true" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" HeaderImage-Url="images/info.png">
                <ContentCollection>
                    <dxpc:PopupControlContentControl runat="server">
                        <div style="width: 250px; text-align: center">
                            <div>You are about to submit your application, <br />do you want to continue?</div>
                            <br />
                            <div class="centered" style="width: 125px">
                                <table style="padding: 0px; width: 125px">
                                    <tr>
                                        <td style="text-align: right">
                                            <dxe:ASPxButton ID="cmdYes_014" runat="server" ClientInstanceName="cmdYes_014" Text="Yes" Width="50px" AutoPostBack="false">
                                                <ClientSideEvents Click="function(s, e) { pcSubmit_014.Hide(); 
                                                    var mainIFrame = top.$('[name=contentUrlPane]')[0].contentWindow;
                                                    typeof mainIFrame.addFormSpecificYesOrNo == 'function' && mainIFrame.addFormSpecificYesOrNo(); }" />
                                            </dxe:ASPxButton>
                                        </td>
                                        <td style="width: 10px" />
                                        <td style="text-align: left">
                                            <dxe:ASPxButton ID="cmdNo_014" runat="server" ClientInstanceName="cmdNo_014" Text="No" Width="50px" AutoPostBack="false">
                                                <ClientSideEvents Click="function(s, e) { pcSubmit_014.Hide(); }" />
                                            </dxe:ASPxButton>
                                        </td>
                                    </tr>
                ...
                <ClientSideEvents PopUp="function(s, e) { pcSubmit_014.AdjustSize(); cmdYes_014.SetFocus(); }" />
            </dxpc:ASPxPopupControl>
            <dxpc:ASPxPopupControl ID="pcYesOrNo" runat="server" ClientInstanceName="pcYesOrNo" AllowDragging="true" CloseAction="CloseButton" EnableAnimation="false" Modal="true" PopupHorizontalAlign="WindowCenter" PopupVerticalAlign="WindowCenter" HeaderImage-Url="images/info.png">
                <ContentCollection>
                    <dxpc:PopupControlContentControl runat="server">
                        <div style="width: 250px; text-align: center">
                            <div>HRD Budget exceeded! Training Investment of more than P50,000.00 should be shouldered by your Department.<br />do you want to continue?</div>
                            <br />
                            <div class="centered" style="width: 125px">
                                <table style="padding: 0px; width: 125px">
                                    <tr>
                                        <td style="text-align: right">
                                            <dxe:ASPxButton ID="cmdYes_007" runat="server" ClientInstanceName="cmdYes_007" Text="Yes" Width="50px" AutoPostBack="false">
                                                <ClientSideEvents Click="function(s, e) { pcYesOrNo.Hide(); 
                                                    var mainIFrame = top.$('[name=contentUrlPane]')[0].contentWindow;
                                                    typeof mainIFrame.addFormSpecificYesOrNo == 'function' && mainIFrame.addFormSpecificYesOrNo(); }" />
                                            </dxe:ASPxButton>
                                        </td>
                                        <td style="width: 10px" />
                                        <td style="text-align: left">
                                            <dxe:ASPxButton ID="cmdNo_007" runat="server" ClientInstanceName="cmdNo_007" Text="No" Width="50px" AutoPostBack="false">
                                                <ClientSideEvents Click="function(s, e) { pcYesOrNo.Hide(); }" />
                                            </dxe:ASPxButton>
                                        </td>
                                    </tr>
                ...
                <ClientSideEvents PopUp="function(s, e) { pcYesOrNo.AdjustSize(); cmdYes_007.SetFocus(); }" />
            </dxpc:ASPxPopupControl>
                                    ...
                                    <tr>
                                        <td style="text-align: right">
                                            <dxe:ASPxButton ID="cmdYes_002" runat="server" ClientInstanceName="cmdYes_002" Text="Yes" Width="50px" AutoPostBack="false">
                                                ...
                                                <ClientSideEvents Click="function(s, e) { tmrCount.SetEnabled(false); tmrTimeout.SetEnabled(false); pcTimeout.Hide(); }" />
                                            </dxe:ASPxButton>
                                        </td>
                                        <td style="width: 10px" />
                                        <td style="text-align: left">
