                            ...
                            <dxw:ContentControl ID="ContentControl7" runat="server">
                                <table style="padding: 0px 0px 0px 0px">
                                    ...
                                    <%--<tr>
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtBlazer" runat="server" Width="250px" ClientInstanceName="txtBlazer" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblSkirt" runat="server" Text="Skirt" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtSkirt" runat="server" Width="250px" ClientInstanceName="txtSkirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td />
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblBlouse" runat="server" Text="Blouse" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtBlouse" runat="server" Width="250px" ClientInstanceName="txtBlouse" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblSlacks" runat="server" Text="Slacks" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtSlacks" runat="server" Width="250px" ClientInstanceName="txtSlacks" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td />
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblShirtjack" runat="server" Text="Shirtjack" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtShirtjack" runat="server" Width="250px" ClientInstanceName="txtShirtjack" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblShirtjackPants" runat="server" Text="Shirtjack Pants" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtShirtjackPants" runat="server" Width="250px" ClientInstanceName="txtShirtjackPants" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td />
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblPoloBarong" runat="server" Text="Polo/Barong" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtPoloBarong" runat="server" Width="250px" ClientInstanceName="txtPoloBarong" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblRepellantPants" runat="server" Text="Repellant Pants" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRepellantPants" runat="server" Width="250px" ClientInstanceName="txtRepellantPants" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td />
                                    </tr>
                                    <tr hidden="hidden">
                                    ...
                                    <tr hidden="hidden">
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblPoloShirt" runat="server" Text="Polo Shirt" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtPoloShirt" runat="server" Width="250px" ClientInstanceName="txtPoloShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblMaongPants" runat="server" Text="Maong Pants" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtMaongPants" runat="server" Width="250px" ClientInstanceName="txtMaongPants" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td />
                                    </tr>
                                    <tr hidden="hidden">
                                    ...
                                    <tr hidden="hidden">
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblTShirt" runat="server" Text="T-Shirt" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtTShirt" runat="server" Width="250px" ClientInstanceName="txtTShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblOveralls" runat="server" Text="Overalls" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtOveralls" runat="server" Width="250px" ClientInstanceName="txtOveralls" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td />
                                    </tr>
                                    <tr>
                                    ...
                                    <tr >
                                        <td style="text-align: right">
                                            <dxe:ASPxLabel ID="lblShirtSize" runat="server" Text="Shirt Size" />
                                        </td>
                                        <td />
                                        <td style="text-align: left">
                                    ...
                                    <%--<tr>
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtMALE_MGRSpecialPoloshirt" runat="server" Width="250px" ClientInstanceName="txtMALE_MGRSpecialPoloshirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtMALE_SUSpecialPoloshirt" runat="server" Width="250px" ClientInstanceName="txtMALE_SUSpecialPoloshirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtMALE_Polo" runat="server" Width="250px" ClientInstanceName="txtMALE_Polo" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtMALE_MaleShirtpackShort" runat="server" Width="250px" ClientInstanceName="txtMALE_MaleShirtpackShort" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtMALE_MaleShirtPackLong" runat="server" Width="250px" ClientInstanceName="txtMALE_MaleShirtPackLong" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtMALE_MaleBlackPants" runat="server" Width="250px" ClientInstanceName="txtMALE_MaleBlackPants" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_MGRSpecialPoloshirt" runat="server" Width="250px" ClientInstanceName="txtFEMALE_MGRSpecialPoloshirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_SUSpecialPoloshirt" runat="server" Width="250px" ClientInstanceName="txtFEMALE_SUSpecialPoloshirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_Blouse" runat="server" Width="250px" ClientInstanceName="txtFEMALE_Blouse" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_FemaleShirtpackShort" runat="server" Width="250px" ClientInstanceName="txtFEMALE_FemaleShirtpackShort" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_FemaleShirtPackLong" runat="server" Width="250px" ClientInstanceName="txtFEMALE_FemaleShirtPackLong" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_FemaleBlackPants" runat="server" Width="250px" ClientInstanceName="txtFEMALE_FemaleBlackPants" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_Skirt" runat="server" Width="250px" ClientInstanceName="txtFEMALE_Skirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtFEMALE_Blazer" runat="server" Width="250px" ClientInstanceName="txtFEMALE_Blazer" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtUNISEX_ProdSUShirt" runat="server" Width="250px" ClientInstanceName="txtUNISEX_ProdSUShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtUNISEX_ProdRNFShirt" runat="server" Width="250px" ClientInstanceName="txtUNISEX_ProdRNFShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtUNISEX_MaongPants" runat="server" Width="250px" ClientInstanceName="txtUNISEX_MaongPants" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtUNISEX_RepellantPants" runat="server" Width="250px" ClientInstanceName="txtUNISEX_RepellantPants" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_RNFSpecialShirt" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_RNFSpecialShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_CampaignShirt" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_CampaignShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_SpecialShirt" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_SpecialShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_Polo2" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_Polo2" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_Polo3" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_Polo3" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_MaleSlacks" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_MaleSlacks" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_MaleSlacks2" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_MaleSlacks2" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_MaleBlackPants2" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_MaleBlackPants2" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDMALE_MaleSpecialJacket" runat="server" Width="250px" ClientInstanceName="txtRESERVEDMALE_MaleSpecialJacket" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_RNFSpecialShirt" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_RNFSpecialShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_CampaignShirt" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_CampaignShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_SpecialShirt" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_SpecialShirt" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_Blouse2" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_Blouse2" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_Blouse3" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_Blouse3" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_FemaleSlacks" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_FemaleSlacks" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_FemaleSlacks2" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_FemaleSlacks2" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_FemaleBlackPants2" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_FemaleBlackPants2" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_Skirt2" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_Skirt2" ReadOnly="false" Enabled="True" />
                                        </td>
                                        <td style="text-align: right">
                                        ...
                                        <td />
                                        <td style="text-align: left">
                                            <dxe:ASPxTextBox ID="txtRESERVEDFEMALE_FemaleSpecialJacket" runat="server" Width="250px" ClientInstanceName="txtRESERVEDFEMALE_FemaleSpecialJacket" ReadOnly="false" Enabled="True" />
                                        </td>
