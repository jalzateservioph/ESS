<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="TWSCorporation.aspx.vb" Inherits="SmartHR.TWSCorporation" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        ...
        <script language="javascript" type="text/javascript"> $(document).ready(function () { window.parent.lpPage.Hide(); }); </script>
    </head>
    <body>
        <form id="form1" runat="server">
            <div>
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td align="center">
                                        <dx:ASPxLabel id="lblResult" runat="server" Text="CORPORATE AND DIVISIONAL RESULTS" Font-Size="30px" ForeColor="Black" Font-Bold="True" Font-Names="Times New Roman"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
                        <td>
                            <table width="300px">
                                ...
                                <tr align="center">
                                    <td colspan="2">
                                        <dx:ASPxButton runat="server" Text="Back" ID="btnBack" CssFilePath="~/App_Themes/Aqua/{0}/styles.css" CssPostfix="Aqua" SpriteCssFilePath="~/App_Themes/Aqua/{0}/sprite.css" Width="100"><ClientSideEvents Click="function(s, e) { window.parent.lpPage.Show(); }" /></dx:ASPxButton>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <dx:ASPxPivotGrid ID="LDRCorporate" runat="server" ClientIDMode="AutoID">
                    <Fields>
                        <dx:PivotGridField ID="yDivision"   Area="ColumnArea" AreaIndex="0" FieldName="Division"/>
                    ...
                    <Styles CssFilePath="~/App_Themes/BlackGlass/{0}/styles.css" CssPostfix="BlackGlass">
                        <HeaderStyle>
                            <HoverStyle><BackgroundImage ImageUrl="~/App_Themes/BlackGlass/PivotGrid/pgHeaderBackHot.gif" Repeat="RepeatX" /></HoverStyle>
                        ...
                        <FieldValueStyle><Paddings PaddingBottom="3px" PaddingTop="3px" /></FieldValueStyle>
                        <FilterButtonPanelStyle><BackgroundImage ImageUrl="~/App_Themes/BlackGlass/PivotGrid/pgFilterPanelBack.gif" Repeat="RepeatX" /></FilterButtonPanelStyle>
                ...
                <dx:ASPxPivotGrid ID="TWSCorporate" runat="server" ClientIDMode="AutoID">
                    <Fields>
                        <dx:PivotGridField ID="xDivision"   Area="ColumnArea" AreaIndex="0" FieldName="Division"/>
