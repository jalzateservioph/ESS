    ...
    <body onload="window.parent.reset();">
        <form id="_setup" runat="server">
            <dxcb:ASPxCallback ID="cpPage" runat="server" ClientInstanceName="cpPage">
                <ClientSideEvents CallbackComplete="function(s, e) { var response = e.result.split('\ '); window.parent.reset(); if (response[1] != undefined) { window.parent.ShowPopup(response[1]); } }" />
            </dxcb:ASPxCallback>
            ...
            <div class="padding">
                <dxtc:ASPxPageControl ID="tabSetup" runat="server" Width="100%" ActiveTabIndex="1">
                    <TabPages>
...
<ClientSideEvents Click="function(s, e) { window.parent.lpPage.Show(); cpPage.PerformCallback('GlobalSubmitCascade'); }" />
                                    ...
                                    <dxwgv:ASPxGridView ID="dgView_002" runat="server" ClientInstanceName="dgView_002" Width="100%" KeyFieldName="ID" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                        <Columns>
                                            <dxwgv:GridViewDataTextColumn FieldName="ID"         Caption="Item No."  VisibleIndex="0" HeaderStyle-Wrap="True" Width="10%">
<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="ModuleName" Caption="Module"    VisibleIndex="1" HeaderStyle-Wrap="True" Width="15%">
<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="TabName"    Caption="Tab"       VisibleIndex="2" HeaderStyle-Wrap="True" Width="15%">
<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="ItemName"   Caption="Item Name" VisibleIndex="3" HeaderStyle-Wrap="True" Width="20%">
<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="Category"          Visible="false" VisibleIndex="0" />
                                            <dxwgv:GridViewDataTextColumn FieldName="Label"             Visible="false" VisibleIndex="0" />
                                            <dxwgv:GridViewDataTextColumn FieldName="Assembly"          Visible="false" VisibleIndex="0" />
                                            <dxwgv:GridViewDataTextColumn FieldName="AssemblyTypeName"  Visible="false" VisibleIndex="0" />
                                            <dxwgv:GridViewDataTextColumn FieldName="DataType"          Visible="false" VisibleIndex="0" />
                                            <dxwgv:GridViewDataTextColumn FieldName="DataTypeName"      Visible="false" VisibleIndex="0" />
                                            <dxwgv:GridViewDataTextColumn FieldName="Key"               Visible="false" VisibleIndex="0" />
                                            <dxwgv:GridViewDataCheckColumn FieldName="Visible" Caption="Visible" VisibleIndex="4" HeaderStyle-Wrap="True" Width="8%">
                                                <DataItemTemplate><dxe:ASPxCheckBox id="chkVisible_002" runat="server" ClientInstanceName="chkVisible_002" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataCheckColumn>
                                            <dxwgv:GridViewDataCheckColumn FieldName="Editable" Caption="Editable" VisibleIndex="5" HeaderStyle-Wrap="True" Width="8%">
                                                <DataItemTemplate><dxe:ASPxCheckBox id="chkEditable_002" runat="server" ClientInstanceName="chkEditable_002" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataCheckColumn>
                                            <dxwgv:GridViewDataCheckColumn FieldName="Required" Caption="Required" VisibleIndex="6" HeaderStyle-Wrap="True" Width="8%">
                                                <DataItemTemplate><dxe:ASPxCheckBox id="chkRequired_002" runat="server" ClientInstanceName="chkRequired_002" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataCheckColumn>
                                            <dxwgv:GridViewDataCheckColumn FieldName="Approval" Caption="Requires Approval?" VisibleIndex="7" HeaderStyle-Wrap="True" Width="8%">
                                                <DataItemTemplate><dxe:ASPxCheckBox id="chkApproval_002" runat="server" ClientInstanceName="chkApproval_002" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                            </dxwgv:GridViewDataCheckColumn>
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="ApprovalLevel" Caption="Level of Approval" VisibleIndex="8" HeaderStyle-Wrap="True" Width="8%" CellStyle-HorizontalAlign="Center" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                                <DataItemTemplate><dxe:ASPxSpinEdit id="chkLevel_002" runat="server" ClientInstanceName="chkLevel_002" MinValue="1" MaxValue="5" Width="50px" HorizontalAlign="Center" /></DataItemTemplate>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left; width: 275px">
                                                            <dxe:ASPxComboBox ID="cmbTemplate_004" runat="server" ClientInstanceName="cmbTemplate_004" Width="275px" EnableIncrementalFiltering="true" DropDownStyle="DropDownList" DataSourceID="dsTemplates" TextField="Name" ValueField="Code" SelectedIndex="0">
                                                                <ClientSideEvents SelectedIndexChanged="function(s, e) { var template = cmbTemplate_004.GetValue(); window.parent.lpPage.Show(); cpItems_004.PerformCallback('LoadFormsLocal ' + template); }" />
                                                            </dxe:ASPxComboBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                                    ...
                                                    <PanelCollection>
                                                        <dxp:PanelContent ID="PanelContent2" runat="server">
                                                            <dxwgv:ASPxGridView ID="dgView_004" runat="server" ClientInstanceName="dgView_004" Width="100%" KeyFieldName="ID" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                                                <Columns>
                                                                    <dxwgv:GridViewDataTextColumn FieldName="PolicyID"   Caption="Item No."  VisibleIndex="0" HeaderStyle-Wrap="True" Width="10%">
<HeaderStyle Wrap="True"></HeaderStyle>
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    <dxwgv:GridViewDataTextColumn FieldName="ModuleName" Caption="Module"    VisibleIndex="1" HeaderStyle-Wrap="True" Width="15%">
<HeaderStyle Wrap="True"></HeaderStyle>
...
<HeaderStyle Wrap="True"></HeaderStyle>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn FieldName="ItemName"   Caption="Item Name" VisibleIndex="3" HeaderStyle-Wrap="True" Width="20%" SortIndex="0" SortOrder="Ascending">
<HeaderStyle Wrap="True"></HeaderStyle>
                                                                    </dxwgv:GridViewDataTextColumn>
                                                                    ...
                                                                    <dxwgv:GridViewDataTextColumn FieldName="Key"               Visible="false" VisibleIndex="0" />
                                                                    <dxwgv:GridViewDataCheckColumn FieldName="Visible" Caption="Visible" VisibleIndex="4" HeaderStyle-Wrap="True" Width="8%">
                                                                        <DataItemTemplate><dxe:ASPxCheckBox id="chkVisible_004" runat="server" ClientInstanceName="chkVisible_004" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                                                    </dxwgv:GridViewDataCheckColumn>
                                                                    <dxwgv:GridViewDataCheckColumn FieldName="Editable" Caption="Editable" VisibleIndex="5" HeaderStyle-Wrap="True" Width="8%">
                                                                        <DataItemTemplate><dxe:ASPxCheckBox id="chkEditable_004" runat="server" ClientInstanceName="chkEditable_004" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                                                    </dxwgv:GridViewDataCheckColumn>
                                                                    <dxwgv:GridViewDataCheckColumn FieldName="Required" Caption="Required" VisibleIndex="6" HeaderStyle-Wrap="True" Width="8%">
                                                                        <DataItemTemplate><dxe:ASPxCheckBox id="chkRequired_004" runat="server" ClientInstanceName="chkRequired_004" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                                                    </dxwgv:GridViewDataCheckColumn>
                                                                    <dxwgv:GridViewDataCheckColumn FieldName="Approval" Caption="Requires Approval?" VisibleIndex="7" HeaderStyle-Wrap="True" Width="8%">
                                                                        <DataItemTemplate><dxe:ASPxCheckBox id="chkApproval_004" runat="server" ClientInstanceName="chkApproval_004" /></DataItemTemplate>

<HeaderStyle Wrap="True"></HeaderStyle>
                                                                    </dxwgv:GridViewDataCheckColumn>
                                                                    <dxwgv:GridViewDataSpinEditColumn FieldName="ApprovalLevel" Caption="Level of Approval" VisibleIndex="8" HeaderStyle-Wrap="True" Width="8%" CellStyle-HorizontalAlign="Center" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                                                        <DataItemTemplate><dxe:ASPxSpinEdit id="chkLevel_004" runat="server" ClientInstanceName="chkLevel_004" MinValue="1" MaxValue="5" Width="50px" HorizontalAlign="Center" /></DataItemTemplate>
...
<Image Url="images/move_up.png"></Image>
...
<Image Url="images/move_down.png"></Image>
                                                    </dxwgv:GridViewCommandColumnCustomButton>
                                                </CustomButtons>
                                            </dxwgv:GridViewCommandColumn>
                                        </Columns>
