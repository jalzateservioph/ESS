<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="financial.aspx.vb" Inherits="SmartHR.financial" ValidateRequest="false" %>
            ...
            <div class="padding">
                <dxtc:ASPxPageControl ID="tabFinance" runat="server" Width="100%">
                    <TabPages>
                            ...
                            <Controls>
                                <dxwgv:ASPxGridView ID="dgView_001" runat="server" ClientInstanceName="dgView_001" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <dxwgv:GridViewDataTextColumn FieldName="Val0" Caption="Annual Package" VisibleIndex="2" />
                                        <dxwgv:GridViewDataTextColumn FieldName="Val1" Caption="Monthly Package" VisibleIndex="3" />
                                        <dxwgv:GridViewDataTextColumn FieldName="Val2" Caption="Bonus" VisibleIndex="4" />
                                    </Columns>
                        ...
                        <dxtc:TabPage Text="LTIP Data">
                            <TabImage Url="images/financial_002.png" />
                            <Controls>
                                <dxwgv:ASPxGridView ID="dgView_002" runat="server" ClientInstanceName="dgView_002" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                    <Columns>
                                        <dxwgv:GridViewDataTextColumn FieldName="CompositeKey" Visible="false" VisibleIndex="0" />
                                        <dxwgv:GridViewDataDateColumn FieldName="DateFrom" Caption="Pay Date" SortIndex="0" SortOrder="Descending" VisibleIndex="1" />
                                        <dxwgv:GridViewDataTextColumn FieldName="LTIPproduct" Caption="Product" VisibleIndex="2" />
                                        <dxwgv:GridViewDataDateColumn FieldName="LTIPissuedate" Caption="Issue Date" VisibleIndex="3" />
                                        <dxwgv:GridViewDataTextColumn FieldName="LTIPtransactiontype" Caption="Trans. Type" VisibleIndex="4" />
                                        <dxwgv:GridViewDataTextColumn FieldName="LTIPquantity" Caption="Qty" VisibleIndex="5" />
                                        <dxwgv:GridViewDataTextColumn FieldName="LTIPwhatwasgiven" Caption="What was Given?" VisibleIndex="6" />
                                        <dxwgv:GridViewDataTextColumn FieldName="LTIPwhathasbeentaken" Caption="What was Taken?" VisibleIndex="7" />
                                        <dxwgv:GridViewDataTextColumn FieldName="LTIPdistribution" Caption="Distribution" VisibleIndex="8" />
                                        <dxwgv:GridViewDataTextColumn FieldName="LTIPcurrentvalue" Caption="Value" VisibleIndex="9" />
                                ...
                                <dxwgv:ASPxGridView ID="dgView_003" runat="server" ClientInstanceName="dgView_003" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                    <Columns>
                                        <dxwgv:GridViewCommandColumn ButtonType="Image" Name="select" VisibleIndex="0" Width="16px">
                                            <CustomButtons>
                                                <dxwgv:GridViewCommandColumnCustomButton ID="Select_003" Image-Url="images/select.png" />
                                            </CustomButtons>
