...
<TabImage Url="images/performance_008.png"></TabImage>
                            <ContentCollection>
...
<CellStyle HorizontalAlign="Center"></CellStyle>
                                                ...
                                                <HeaderTemplate>
                                                    ...
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) { dgView_004.PerformCallback('1\ ' + s.GetValue()); }" /></dxe:ASPxComboBox>
                                                </HeaderTemplate>
...
<CellStyle HorizontalAlign="Center"></CellStyle>
                                                ...
                                                <HeaderTemplate>
                                                    ...
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) { dgView_004.PerformCallback('2\ ' + s.GetValue()); }" /></dxe:ASPxComboBox>
                                                </HeaderTemplate>
                                            </dxwgv:GridViewBandColumn>
                                        </Columns>
...
<Settings ShowHeaderFilterButton="True" ShowStatusBar="Visible" ShowFilterBar="Visible"></Settings>
                                                        ...
                                                        <td style="width: 105px">
                                                            <dxm:ASPxMenu ID="mnuExport_004" runat="server" HorizontalAlign="Left" OnItemClick="mnuExport_ItemClick">
                                                                <Items>
                                                                    ...
                                                                    <SubMenuStyle Cursor="pointer" /></dxm:MenuItem>
                                                                </Items>
                                                            </dxm:ASPxMenu>
                                                        </td>
                                                    </tr>
...
<TabImage Url="images/leave_001.png"></TabImage>
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
                                            ...
                                            <dxp:PanelContent runat="server">
                                                <asp:Table ID="tblApplication" runat="server" Width="100%">
                                                    ...
                                                    <asp:TableRow Height="5px">
                                                        <asp:TableCell ColumnSpan="3" >Select your Start Date</asp:TableCell>
<asp:TableCell runat="server"></asp:TableCell>
<asp:TableCell runat="server">Select your End date</asp:TableCell>
                                                    </asp:TableRow>
                                                    <asp:TableRow HorizontalAlign="Center">
                                                        <asp:TableCell>
...
<ClientSideEvents VisibleMonthChanged="function(s, e) { if (s.GetVisibleDate() &gt; calUntil.GetVisibleDate()) { calUntil.SetVisibleDate(s.GetVisibleDate()); } }" SelectionChanged="function(s, e) { window.parent.lpPage.Show(); cpPage.PerformCallback(&#39;Select&#39;); }"></ClientSideEvents>
                                                            </dxe:ASPxCalendar>
                                                        </asp:TableCell>
                                                        <asp:TableCell>
...
<ClientSideEvents VisibleMonthChanged="function(s, e) { if (s.GetVisibleDate() &lt; calFrom.GetVisibleDate()) { calFrom.SetVisibleDate(s.GetVisibleDate()); } }" SelectionChanged="function(s, e) { window.parent.lpPage.Show(); cpPage.PerformCallback(&#39;Select&#39;); }"></ClientSideEvents>
                                                            </dxe:ASPxCalendar>
                                                        </asp:TableCell>
                                                    </asp:TableRow>
                                                    <asp:TableRow Height="5px">
                                                        ...
                                                        <asp:TableCell ColumnSpan="3">
                                                            <asp:Table ID="tblApplicationType" runat="server" Width="100%">
                                                                <asp:TableRow>
                                                                    ...
                                                                    <asp:TableCell Width="10px"  Visible="false">Select your Leave Type</asp:TableCell>
...
<ClientSideEvents SelectedIndexChanged="function(s, e) { window.parent.lpPage.Show(); cpPage.PerformCallback(&#39;Select&#39;); }"></ClientSideEvents>
                                                                        </dxe:ASPxComboBox>
                                                                    </asp:TableCell>
                                                                </asp:TableRow>
                                                                <asp:TableRow Height="5px">
                                                                ...
                                                                <asp:TableRow>
                                                                    ...
                                                                    <asp:TableCell Width="10px"  Visible="false">Duration</asp:TableCell>
                                                                    <asp:TableCell HorizontalAlign="Left">
...
<ClientSideEvents NumberChanged="function(s, e) { if (s.GetValue() == 0.25 || s.GetValue() == 0.5 || s.GetValue() == 0.75) { pnlTime.SetVisible(true); } else { pnlTime.SetVisible(false); } }"></ClientSideEvents>
                                                                                    </dxe:ASPxSpinEdit>
                                                                                </asp:TableCell>
                                                                                <asp:TableCell Width="10px" />
                                                                                <asp:TableCell HorizontalAlign="Left">
...
<ClientSideEvents Init="function(s, e) { if (spnDuration.GetValue() == 0.5) { s.SetVisible(true); } else { s.SetVisible(false); } }"></ClientSideEvents>
                                                                            <PanelCollection>
                                                                                <dxp:PanelContent>
                                                                ...
                                                                <asp:TableRow ID="trDocument_001" runat="server">
                                                                    ...
                                                                    <asp:TableCell Width="10px" Visible="false">* Attach a document</asp:TableCell>
                                                                    <asp:TableCell HorizontalAlign="Left">
...
<ValidationSettings MaxFileSize="4096000"></ValidationSettings>

<ClientSideEvents FileUploadComplete="function(s, e) { cpPage.PerformCallback(&#39;Submit&#39;); }"></ClientSideEvents>
...
<TabImage Url="images/leave_002.png"></TabImage>
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
                                    <div style="width: 100%">
...
<ClientSideEvents DateChanged="function(s, e) { dgView_001.Refresh(); }"></ClientSideEvents>
                                                    </dxe:ASPxDateEdit>
                                                </td>
                                                <td />
                                            <td /></tr>
...
<ClientSideEvents SelectionChanged="function(s, e) { if (e.isSelected) { window.parent.lpPage.Show(); dgView_001.PerformCallback(e.visibleIndex); } }" EndCallback="function(s, e) {
                                                                            if (s.cpIsSelected) {
...
<Image Url="images/select.png"></Image>
                                            ...
                                            <dxwgv:GridViewDataTextColumn ShowInCustomizationForm="True" VisibleIndex="5" FieldName="TotalBalance" 
                                                Caption="Total Balance JR" HeaderStyle-Font-Bold="true">
                                            <HeaderStyle Font-Bold="True"></HeaderStyle></dxwgv:GridViewDataTextColumn>
                                            
                                            <%--<dxwgv:GridViewDataSpinEditColumn FieldName="TotalBalance1" 
                                                Caption="Total Balance" VisibleIndex="6" HeaderStyle-Font-Bold="true" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>

<HeaderStyle Font-Bold="True"></HeaderStyle>
                                            </dxwgv:GridViewDataSpinEditColumn>--%>
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="Balance" 
                                                Caption="Remaining (this cycle)" VisibleIndex="7" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                            </dxwgv:GridViewDataSpinEditColumn>
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="AccumBalance" 
                                                Caption="Accum Balance" VisibleIndex="8" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                            </dxwgv:GridViewDataSpinEditColumn>
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="TotalAccrual" 
                                                Caption="Total Accrual" VisibleIndex="9" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                            </dxwgv:GridViewDataSpinEditColumn>
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="TotalTaken" 
                                                Caption="Taken (this cycle)" VisibleIndex="10" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                            </dxwgv:GridViewDataSpinEditColumn>
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="TotalFuture" 
                                                Caption="Future Taken" VisibleIndex="11" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                            </dxwgv:GridViewDataSpinEditColumn>
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="AtRisk" Caption="No. Risk" 
                                                VisibleIndex="12" >
<PropertiesSpinEdit DisplayFormatString="g"></PropertiesSpinEdit>
                                            </dxwgv:GridViewDataSpinEditColumn>
                                            <dxwgv:GridViewDataDateColumn FieldName="NextLostDate" Caption="Lose At" 
                                                VisibleIndex="13" />
                                        </Columns>
                                        <ClientSideEvents EndCallback="function(s, e) {
                                                                            if (s.cpIsSelected) {
...
<TabImage Url="images/leave_003.png"></TabImage>
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
...
<ClientSideEvents SelectionChanged="function(s, e) { if (e.isSelected) { window.parent.lpPage.Show(); dgView_002.PerformCallback(e.visibleIndex); } }" CustomButtonClick="function(s, e) { e.processOnServer = true; if (e.buttonID == &#39;Cancel&#39;) { if (!confirm(&#39;Confirm Cancel?&#39;)) { e.processOnServer = false; } else { e.processOnServer = true; } } }" EndCallback="function(s, e) {
                                                                            if (s.cpIsSelected) {
                                                                                s.cpIsSelected = false;
                                                                                window.parent.reset();
...
<Image Url="images/select.png"></Image>
                                            ...
                                            <dxwgv:GridViewCommandColumn ButtonType="Image" Name="cancel" VisibleIndex="11" Width="16px">
                                                <CustomButtons>
                                                    <dxwgv:GridViewCommandColumnCustomButton ID="Cancel" 
                                                        Image-Url="images/stop.png" Text="Cancel Record" >
<Image Url="images/stop.png"></Image>
...
<TabImage Url="images/leave_005.png"></TabImage>
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
...
<DeleteButton Text="Delete Record"></DeleteButton>
                                                <CustomButtons>
                                                    <dxwgv:GridViewCommandColumnCustomButton ID="delete_003" 
...
<SettingsEditing NewItemRowPosition="Bottom"></SettingsEditing>
                                                ...
                                                <table style="padding: 2px; width: 100%">
                                                    <tr>
                                                        ...
                                                        <td style="width: 80px">
                                                            ...
                                                            <ClientSideEvents Click="function(s, e) { dgView_003.AddNewRow(); }" /></dxe:ASPxButton>
                                                        </td>
                                                        <td style="width: 10px" /><td style="width: 10px" ><dxm:ASPxMenu ID="mnuExport_003" runat="server" HorizontalAlign="Left" OnItemClick="mnuExport_ItemClick"><Items><dxm:MenuItem Name="mnuExport_003" Text="Export to"><Items><dxm:MenuItem Name="mnuExp_CSV" Text="Comma-Seperated Values (CSV)" />
                                                                            <dxm:MenuItem Name="mnuExp_XLS" Text="Microsoft Excel 97 to 2003 (XLS)" />
                                                                            <dxm:MenuItem Name="mnuExp_XLSX" Text="Microsoft Excel 2007 to 2010 (XLSX)" />
                                                                            <dxm:MenuItem Name="mnuExp_RTF" Text="Rich Text Format (RTF)" />
                                                                            <dxm:MenuItem Name="mnuExp_PDF" Text="Portable Document Format (PDF)" />
...
<ClientSideEvents ActiveTabChanged="function(s, e) {
                        ...
                        EndCallback="function(s, e) { s.GetTab(0).SetVisible(s.cpVisibleResults); s.GetTab(4).SetVisible(s.cpVisible); }" 
                        Init="function(s, e) { s.GetTab(0).SetVisible(s.cpVisibleResults); s.GetTab(4).SetVisible(s.cpVisible); }"></ClientSideEvents>
