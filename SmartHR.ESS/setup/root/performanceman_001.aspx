...
<Paddings PaddingTop="1px" PaddingBottom="1px"></Paddings>
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="CareerLevel" Caption="Career Level" 
                                                VisibleIndex="6" />
<dxwgv:GridViewDataTextColumn FieldName="Position" ShowInCustomizationForm="True" Caption="Position" VisibleIndex="5"></dxwgv:GridViewDataTextColumn>
<dxwgv:GridViewDataTextColumn FieldName="JobTitle" ShowInCustomizationForm="True" Caption="Job Title" VisibleIndex="7" 
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="CostCentre" Caption="Cost Centre" 
                                                VisibleIndex="9" />
                                            <dxwgv:GridViewDataTextColumn FieldName="DeptName" Caption="Department" 
                                                VisibleIndex="10" />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxComboBox ID="cmbSchemeAll_002" runat="server" ClientInstanceName="cmbSchemeAll_002" EnableIncrementalFiltering="true" DropDownStyle="DropDownList" DataSourceID="dsScheme" TextField="Name" ValueField="SchemeCode" Width="375px">
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) { items_004.Set('SelectedKey', s.GetValue()); dgView_004.PerformCallback(''); }" />
<ClientSideEvents SelectedIndexChanged="function(s, e) { items_004.Set(&#39;SelectedKey&#39;, s.GetValue()); dgView_004.PerformCallback(&#39;&#39;); }"></ClientSideEvents>
                                                </dxe:ASPxComboBox>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <dxe:ASPxComboBox ID="cmbTypeAll_002" runat="server" ClientInstanceName="cmbTypeAll_002" EnableIncrementalFiltering="true" DropDownStyle="DropDownList" Width="175px">
                                                    <ClientSideEvents SelectedIndexChanged="function(s, e) { items_004.Set('SelectedKeyType', s.GetValue()); dgView_004.PerformCallback(''); }" />
<ClientSideEvents SelectedIndexChanged="function(s, e) { items_004.Set(&#39;SelectedKeyType&#39;, s.GetValue()); dgView_004.PerformCallback(&#39;&#39;); }"></ClientSideEvents>
                                                    <Items>
                                            ...
                                            <DetailRow>
                                                ...
                                                <dxwgv:ASPxGridView ID="dgView_004" runat="server" ClientInstanceName="dgView_004" Width="100%" KeyFieldName="Value" EnableCallbackCompression="true" AutoGenerateColumns="False" OnDataBound="dgView_001_DataBound" OnHtmlRowCreated="dgView_001_HtmlRowCreated">
                                                    <Columns>
                                                        <dxwgv:GridViewCommandColumn ShowSelectCheckbox="True" Width="16px" VisibleIndex="0">
                                                            <HeaderTemplate>
                                                                <input type="checkbox" onclick="dgView_004.SelectAllRowsOnPage(this.checked);" style="vertical-align:middle;" title="Select / Unselect all rows on the page" />
                                                            </HeaderTemplate>
