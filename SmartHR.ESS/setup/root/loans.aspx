<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="loans.aspx.vb" Inherits="SmartHR.loans" ValidateRequest="false" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body onload="window.parent.reset();">
        <form id="_loans" runat="server">
            ...
            <div class="padding">
                <dxtc:ASPxPageControl ID="tabLoans" runat="server" Width="100%">
                    <TabPages>
                        <dxtc:TabPage Text="Loan: Applications">
                            <TabImage Url="images/loans_001.png" />
                            <ContentCollection>
                        ...
                        <dxtc:TabPage Text="Loans: Status">
                            <TabImage Url="images/loans_002.png" />
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
                                    ...
                                    <dxwgv:ASPxGridView ID="dgView_002" runat="server" ClientInstanceName="dgView_002" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <dxwgv:GridViewDataDateColumn FieldName="LoanDate" Caption="Date Required" SortIndex="0" SortOrder="Descending" VisibleIndex="3" />
                                            <dxwgv:GridViewDataTextColumn FieldName="Term" Caption="Period" VisibleIndex="4" />
                                            <dxwgv:GridViewDataTextColumn FieldName="IntRate" Caption="Interest Rate" VisibleIndex="5" />
                                            <dxwgv:GridViewDataTextColumn FieldName="Amount" Caption="Amount" VisibleIndex="6" />
                                            <dxwgv:GridViewDataTextColumn FieldName="Amount_Paid" Caption="Total Received" VisibleIndex="7" />
                                            <dxwgv:GridViewDataDateColumn FieldName="FirstInstallment" Caption="First Installment" VisibleIndex="8" />
                                            <dxwgv:GridViewDataTextColumn FieldName="LoanStatus" Caption="Status" VisibleIndex="9">
                                                <EditFormSettings Visible="false" />
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataDateColumn FieldName="NotificationDate" Caption="Notify On" VisibleIndex="10" Visible="false">
                                                <EditFormSettings Visible="true" />
                                            </dxwgv:GridViewDataDateColumn>
