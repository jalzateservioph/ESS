<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="timesheets.aspx.vb" Inherits="SmartHR.timesheets" ValidateRequest="false" %>
...
<html xmlns="http://www.w3.org/1999/xhtml" >
    ...
    <body onload="window.parent.reset();">
        <form id="_timesheets" runat="server">
            ...
            <div class="padding">
                <dxtc:ASPxPageControl ID="tabTimesheets" runat="server" Width="100%">
                    <TabPages>
                        <dxtc:TabPage Text="Timesheets: Register">
                            <TabImage Url="images/timesheets_001.png" />
                            <ContentCollection>
                                        ...
                                        <Templates>
                                            <DetailRow>
                                                ...
                                                <dxwgv:ASPxGridView ID="dgView_004" runat="server" ClientInstanceName="dgView_004" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False" OnCancelRowEditing="dgView_001_CancelRowEditing" OnCustomJSProperties="dgView_001_CustomJSProperties" OnDetailRowExpandedChanged="dgView_001_DetailRowExpandedChanged" OnRowDeleting="dgView_001_RowDeleting" OnRowInserting="dgView_001_RowInserting" OnRowUpdating="dgView_001_RowUpdating" OnRowValidating="dgView_001_RowValidating">
                                                    ...
                                                    <Settings ShowHeaderFilterButton="true" ShowStatusBar="Visible" />
                                                                    ...
                                                                    <StatusBar>
                                                                        <table style="padding: 2px; width: 100%">
                                                                            <tr>
                                                                                <td></td>
                                                                                <td style="width: 80px">
                                                                                    <dxe:ASPxButton ID="cmdCreate_012" runat="server" ClientInstanceName="cmdCreate_012" AutoPostBack="false" ForeColor="Black" Height="25px" Text="Create" Width="80px">
                        ...
                        <dxtc:TabPage Text="Timesheets: Status">
                            <TabImage Url="images/timesheets_002.png" />
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
                                    ...
                                    <dxwgv:ASPxGridView ID="dgView_002" runat="server" ClientInstanceName="dgView_002" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="Username" Caption="Captured By" VisibleIndex="6">
                                                <EditFormSettings Visible="false" />
                                            </dxwgv:GridViewDataTextColumn>
                                            <dxwgv:GridViewDataDateColumn FieldName="CapturedDate" Caption="Captured On" VisibleIndex="7">
                                                <EditFormSettings Visible="false" />
                                            </dxwgv:GridViewDataDateColumn>
                                            <dxwgv:GridViewDataTextColumn FieldName="DocPath" VisibleIndex="8" Visible="false" />
                                            <dxwgv:GridViewDataTextColumn FieldName="ESSPath" VisibleIndex="9" Visible="false" />
                                            <dxwgv:GridViewDataTextColumn Caption="#" VisibleIndex="10" Width="16px">
                                                <CellStyle Paddings-PaddingTop="5px" />
                                                <DataItemTemplate>
                                                    <dxe:ASPxImage ID="cmdSelect" runat="server" Cursor="pointer" ToolTip="<%# GetTooltip(Container) %>" ImageUrl="<%# GetImgUrl(Container) %>" ClientSideEvents-Click="<%# GetClickUrl(Container) %>" />
                                                </DataItemTemplate>
                                        ...
                                        <ClientSideEvents CustomButtonClick="function(s, e) { window.parent.ExecDeleteCallback(s, e); }" EndCallback="function(s, e) { if (s.cpRefreshAll) { s.PerformCallback('Reload'); } else { if (s.cpCancelEdit) { s.CancelEdit(); } if (s.cpRefreshDelete) { s.Refresh(); } } }" />
                                        <Settings ShowHeaderFilterButton="true" ShowFilterBar="Visible" ShowStatusBar="Visible" />
                                        <SettingsDetail AllowOnlyOneMasterRowExpanded="true" ShowDetailRow="true" />
                                        <SettingsEditing NewItemRowPosition="Bottom" />
                                        <SettingsPager AlwaysShowPager="True" />
                                        ...
                                        <Templates>
                                            <DetailRow>
                                                ...
                                                <dxwgv:ASPxGridView ID="dgView_006" runat="server" ClientInstanceName="dgView_006" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False" OnCancelRowEditing="dgView_001_CancelRowEditing" OnCustomCallback="dgView_002_CustomCallback" OnCustomJSProperties="dgView_001_CustomJSProperties" OnDetailRowExpandedChanged="dgView_001_DetailRowExpandedChanged" OnHtmlCommandCellPrepared="dgView_002_HtmlCommandCellPrepared" OnRowDeleting="dgView_001_RowDeleting" OnRowInserting="dgView_001_RowInserting" OnRowUpdating="dgView_001_RowUpdating" OnRowValidating="dgView_001_RowValidating">
                                                    <Columns>
                                                        <dxwgv:GridViewCommandColumn ButtonType="Image" Name="edit" CancelButton-Text="Cancel Changes" EditButton-Text="Edit Record" UpdateButton-Text="Update Record" VisibleIndex="0" Width="16px">
                                                            <EditButton Visible="True">
                                                                <Image Url="images/edit.png" />
                                                    ...
                                                    <ClientSideEvents CustomButtonClick="function(s, e) { window.parent.ExecDeleteCallback(s, e); }" EndCallback="function(s, e) { if (s.cpRefreshAll) { dgView_002.CollapseAll(); dgView_002.PerformCallback('Refresh'); } else { if (s.cpRefreshParent) { dgView_002.Refresh(); } else { if (s.cpCancelEdit) { s.CancelEdit(); } if (s.cpRefreshDelete) { s.Refresh(); } } } }" />
                                                    <Settings ShowHeaderFilterButton="true" ShowStatusBar="Visible" />
                                                    <SettingsBehavior AutoExpandAllGroups="true"  />
                                                    <SettingsCookies StoreColumnsVisiblePosition="false" />
                                                    <SettingsDetail AllowOnlyOneMasterRowExpanded="true" IsDetailGrid="true" ShowDetailRow="true" />
                                                    ...
                                                    <Templates>
                                                        <DetailRow>
                                                            ...
                                                            <dxwgv:ASPxGridView ID="dgView_013" runat="server" ClientInstanceName="dgView_013" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False" OnCancelRowEditing="dgView_001_CancelRowEditing" OnCustomCallback="dgView_002_CustomCallback" OnCustomJSProperties="dgView_001_CustomJSProperties" OnRowDeleting="dgView_001_RowDeleting" OnRowInserting="dgView_001_RowInserting" OnRowUpdating="dgView_001_RowUpdating" OnRowValidating="dgView_001_RowValidating">
                                                                <Columns>
                                                                    <dxwgv:GridViewCommandColumn ButtonType="Image" Name="edit" CancelButton-Text="Cancel Changes" EditButton-Text="Edit Record" UpdateButton-Text="Update Record" VisibleIndex="0" Width="16px">
                                                                        <EditButton Visible="True">
                                                                            <Image Url="images/edit.png" />
                                                                ...
                                                                <ClientSideEvents CustomButtonClick="function(s, e) { window.parent.ExecDeleteCallback(s, e); }" EndCallback="function(s, e) { if (s.cpRefreshAll) { dgView_006.CollapseAll(); dgView_006.PerformCallback('Refresh'); } else { if (s.cpCancelEdit) { s.CancelEdit(); } if (s.cpRefreshDelete) { s.Refresh(); } } }" />
                                                                <Settings ShowHeaderFilterButton="true" ShowStatusBar="Visible" ShowFooter="true" ShowGroupPanel="true" />
                                                                <SettingsBehavior AutoExpandAllGroups="true"  />
                                                                <SettingsCookies StoreColumnsVisiblePosition="false" />
                                                                <SettingsDetail IsDetailGrid="true" />
                                                                ...
                                                                <Templates>
                                                                    <EditForm>
                                                                        <div style="padding: 5px; width: 100%">
                                                                            <dxwgv:ASPxGridViewTemplateReplacement ID="Editors_013" ReplacementType="EditFormEditors" runat="server" />
                                                                        </div>
                                                                        <br />
                                                                        <table cellpadding="0" style="text-align: center; width: 100%">
                                                                            <tr>
                                                                                ...
                                                                                <td style="width: 15px"></td>
                                                                                <td style="text-align: left">
                                                                                    <dxuc:ASPxUploadControl ID="upDocument_013" runat="server" ClientInstanceName="upDocument_013" Width="100%" ShowProgressPanel="true" OnFileUploadComplete="upDocument_001_FileUploadComplete">
                                                                                        <ClientSideEvents FileUploadComplete="function(s, e) { dgView_013.UpdateEdit(); }" />
                                                                                        <ValidationSettings MaxFileSize="4096000" />
                                                                                    </dxuc:ASPxUploadControl>
                                                                                </td>
                                                                            </tr>
                                                                        ...
                                                                        <div style="text-align:right; padding: 5px">
                                                                            <span style="cursor: pointer; padding-right: 10px"><dxe:ASPxImage ID="cmdUpdate" runat="server" ImageUrl="images/update.png" ToolTip="Update Record"><ClientSideEvents Click="function(s, e) { if (upDocument_013.GetText().length == 0) { dgView_013.UpdateEdit(); } else { upDocument_013.Upload(); } }" /></dxe:ASPxImage></span>
                                                                            <span style="cursor: pointer"><dxwgv:ASPxGridViewTemplateReplacement ID="CancelButton" ReplacementType="EditFormCancelButton" runat="server" /></span> 
                                                                        </div>
                                                                    </EditForm>
                                                                    <StatusBar>
                        ...
                        <dxtc:TabPage Text="Timesheet Types">
                            <TabImage Url="images/timesheets_003.png" />
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
                        ...
                        <dxtc:TabPage Text="Custom Columns">
                            <TabImage Url="images/timesheets_004.png" />
                            <ContentCollection>
                                <dxw:ContentControl runat="server">
                                    ...
                                    <dxwgv:ASPxGridView ID="dgView_010" runat="server" ClientInstanceName="dgView_010" Width="100%" KeyFieldName="CompositeKey" EnableCallbackCompression="true" AutoGenerateColumns="False">
                                        <Columns>
                                            ...
                                            <dxwgv:GridViewDataCheckColumn FieldName="IsChild" Caption="Is Child?" VisibleIndex="4" />
                                            <dxwgv:GridViewDataCheckColumn FieldName="IsView" Caption="Read-only?" VisibleIndex="5" />
                                            <dxwgv:GridViewDataComboBoxColumn FieldName="AssemblyID" Caption="Control Type" VisibleIndex="6">
                                            ...
                                            <dxwgv:GridViewDataComboBoxColumn FieldName="DataTypeID" Caption="Data Type" VisibleIndex="7">
                                            ...
                                            <dxwgv:GridViewDataSpinEditColumn FieldName="Size" Caption="Data (Size)" VisibleIndex="8" />
                                            <dxwgv:GridViewDataComboBoxColumn FieldName="GroupTypeID" Caption="Summarize?" VisibleIndex="9">
                                            ...
                                            <dxwgv:GridViewDataTextColumn FieldName="Index" Visible="false" SortIndex="0" SortOrder="Ascending" VisibleIndex="10" />
                                            <dxwgv:GridViewCommandColumn ButtonType="Image" Name="up" VisibleIndex="11" Width="16px">
                                                <CustomButtons>
                                                    <dxwgv:GridViewCommandColumnCustomButton ID="Up" Image-Url="images/move_up.png" />
                                                </CustomButtons>
                                            </dxwgv:GridViewCommandColumn>
                                            <dxwgv:GridViewCommandColumn ButtonType="Image" Name="down" VisibleIndex="12" Width="16px">
                                                <CustomButtons>
                                                    <dxwgv:GridViewCommandColumnCustomButton ID="Down" Image-Url="images/move_down.png" />
                                                </CustomButtons>
                                            </dxwgv:GridViewCommandColumn>
                                            <dxwgv:GridViewCommandColumn ButtonType="Image" Name="delete" DeleteButton-Text="Delete Record" VisibleIndex="13" Width="16px">
                                                <CustomButtons>
                                                    <dxwgv:GridViewCommandColumnCustomButton ID="delete_010" Image-Url="images/delete.png" Text="Delete Record" />
                                                </CustomButtons>
                                            </dxwgv:GridViewCommandColumn>
                                        </Columns>
                                        <ClientSideEvents CustomButtonClick="function(s, e) { if (e.buttonID == 'delete_010') { window.parent.ExecDeleteCallback(s, e); } else { e.processOnServer = true; } }" EndCallback="function(s, e) { if (s.cpCancelEdit) { s.CancelEdit(); } }" />
                                        <Settings ShowHeaderFilterButton="true" ShowFilterBar="Visible" ShowStatusBar="Visible" />
                                        ...
                                        <Templates>
                                            <DetailRow>
                                                <table style="padding: 0px; width: 100%">
                                                    <tr>
                                                        <td style="font-size: 10pt; font-weight: bold; text-align: right; width: 125px">Timesheet Types</td>
                                                        <td style="width: 10px"></td>
                                                        <td><hr /></td>
                                                    </tr>
                                                    <tr>
