...
<body onload="window.parent.reset(); EnableDisableButtons();">
    ...
    <script type="text/javascript">
        function getQuerystring() {
            window.showModalDialog("http://localhost/SwirePerfEval/EvaluationFrame.aspx?PathID=<%=Session.Contents("PathID")%>&CurrentUser=<%=Session.Contents("CurrentUser")%>&EvalScheme=<%=Session.Contents("EvalScheme")%>", "window1", "dialogHeight: 700px;dialogWidth: 1150px;");
