            ...
            <div class="padding">
                <dxtc:ASPxPageControl ID="tabWorkflow" runat="server" Width="100%">
                    <TabPages>
                                                                    ...
                                                                    <dxw:ContentControl ID="ContentControl3" runat="server">
                                                                        <div style="text-align: center; width: 100%">
                                                                            <dxhe:ASPxHtmlEditor ID="bodyEditor_001" runat="server" ClientInstanceName="bodyEditor_001" Width="100%" Html='<%# Eval("Body") %>'>
                                                                                ...
                                                                                <SettingsImageUpload UploadImageFolder="~/ESS-TMP-LIVE">
                        ...
                        <dxtc:TabPage Text="Email Template" Name="dgView_006">
                            <TabImage Url="images/workflow_001.png" />
                            <ContentCollection>
                                <dxw:ContentControl ID="ContentControl8" runat="server">
                                                    ...
                                                    <dxcp:ASPxCallbackPanel ID="cpImage" runat="server" ClientInstanceName="cpImage" HideContentOnCallback="false" ShowLoadingPanel="false">
                                                        ...
                                                        <PanelCollection>
                                                            <dxp:PanelContent ID="PanelContent1" runat="server">
                                                                <dxe:ASPxBinaryImage ID="imgPicture" runat="server" ClientInstanceName="imgPicture" ToolTip="Preview" StoreContentBytesInViewState="false">
                                                ...
                                                <asp:TableCell ColumnSpan="3" HorizontalAlign="Center">
                                                    <dxuc:ASPxUploadControl ID="upDocument" runat="server" ClientInstanceName="upDocument" ShowProgressPanel="true" Size="30" OnFileUploadComplete="upDocument_FileUploadComplete">
                                                        <ClientSideEvents FileUploadComplete="function(s, e) { 
                                                            cpImage.PerformCallback(); 

                                                            setTimeout(function() {
                                                                document.getElementById('tabWorkflow_emailEditor_001_DesignIFrame').contentDocument.location.reload(); 
                                                                console.log('done');
                                                                }, 1000);
                                    ...
                                    <div style="text-align: center; width: 100%">
                                        <dxhe:ASPxHtmlEditor ID="emailEditor_001" runat="server" ClientInstanceName="emailEditor_001" Width="100%" OnLoad="emailEditor_001_Load">
                                        <%--<dxhe:ASPxHtmlEditor ID="ASPxHtmlEditor1" runat="server" ClientInstanceName="emailEditor_001" Width="100%" OnLoad="emailEditor_001_Load">--%>
                                            <Settings AllowDesignView="false" AllowHtmlView="false" AllowPreview="false" />
                                            <SettingsImageUpload UploadImageFolder="~/ESS-TMP-LIVE">
                                                <ValidationSettings AllowedContentTypes="image/jpeg, image/pjpeg, image/gif, image/png, image/x-png">
                                                </ValidationSettings>
                                    ...
                                    <div class="centered" style="width: 80px; margin-top: 20px; margin-bottom: 10px">
                                        <dxe:ASPxButton ID="cmdUpdate" runat="server" Text="Update Template" Width="80px" AutoPostBack="false" OnClick="cmdUpdate_Click" />
                                    </div>
                                </dxw:ContentControl>
                            </ContentCollection>
                        </dxtc:TabPage>
                    ...
                    <ClientSideEvents ActiveTabChanged="function(s, e) {
                                    ...
                                    <%--ActiveTabChanging="function(s, e) {
                                                        e.reloadContentOnCallback = false;
